...
/* compute <val1> + <val2> */
static struct eval_value_t f_add(struct eval_value_t val1,
...
/* compute <val1> - <val2> */
static struct eval_value_t f_sub(struct eval_value_t val1,
		struct eval_value_t val2) {
	enum eval_type_t et;
	struct eval_value_t val;
...
/* compute <val1> * <val2> */
static struct eval_value_t f_mult(struct eval_value_t val1,
		struct eval_value_t val2) {
	enum eval_type_t et;
	struct eval_value_t val;
...
/* compute <val1> / <val2> */
static struct eval_value_t f_div(struct eval_value_t val1,
		struct eval_value_t val2) {
	enum eval_type_t et;
	struct eval_value_t val;
...
/* compute - <val1> */
static struct eval_value_t f_neg(struct eval_value_t val1) {
	struct eval_value_t val;
...
/* compute val1 == 0 */
static int f_eq_zero(struct eval_value_t val1) {
	int val;
...
/* delete an evaluator */
void eval_delete(struct eval_state_t *es) /* evaluator to delete */
{
	free(es);
}
