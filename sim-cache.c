...
void sim_reg_options(struct opt_odb_t *odb) /* options database */
{
	...
	opt_reg_string(odb, "-cache:dl1",
			...
			"dl1:256:32:1:l", /* print */TRUE, NULL);
	opt_reg_note(odb,
	...
	opt_reg_string(odb, "-cache:dl2",
			...
			"ul2:1024:64:4:l", /* print */TRUE, NULL);
...
int argc, char **argv) /* command line arguments */
{
	...
	} else /* dl1 is defined */
	{
		...
		/* usize */0, assoc, cache_char2policy(c), dl1_access_fn, /* hit latency */
				1);
		...
		if (!mystricmp(cache_dl2_opt, "none"))
			...
			/* usize */0, assoc, cache_char2policy(c), dl2_access_fn, /* hit latency */
					1);
		}
	}
	...
	} else /* il1 is defined */
	{
		...
		/* usize */0, assoc, cache_char2policy(c), il1_access_fn, /* hit latency */
				1);
		...
		if (!mystricmp(cache_il2_opt, "none"))
			...
			/* usize */0, assoc, cache_char2policy(c), il2_access_fn, /* hit latency */
					1);
		}
	}
...
enum md_fault_type dcache_access_fn(struct mem_t *mem, /* memory space to access */
...
void sim_main(void) {
	...
	if (dlite_check_break(regs.regs_PC, /* no access */0, /* addr */0, 0, 0))
		dlite_main(regs.regs_PC - sizeof(md_inst_t), regs.regs_PC, sim_num_insn,
				&regs, mem);
